...
//
// We calculate coefficients for the harmonics
// that we actually use.
// =====================================================

static void calculate_dft(
    ecg_state_t *chip
)
{
    for (
...
//
// Because the original ECG is real-valued:
//
// X[-k] = conjugate(X[k])
//
// Therefore:
...
void chip_init(void)
{
    ...
    //
    // We don't want to perform the DFT for every
    // ECG sample.
    // ---------------------------------------------
